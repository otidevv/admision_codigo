...
namespace admision.Controllers.Admin.InfoManagementController
{
    ...
    [Route("admin/info-management/syllabi")]
    public class SyllabiController : Controller
    {
        private const string Category = AppConstants.OtherFileCategory.Temario;
        private const string StorageModule = "Syllabi";
        private const string ViewFolder = "Syllabi";
        private const string Label = "Temario";

        private readonly IOtherFilesService _files;
        private readonly ILogger<SyllabiController> _logger;

        public SyllabiController(IOtherFilesService files, ILogger<SyllabiController> logger)
        {
            _files = files;
            _logger = logger;
        }
