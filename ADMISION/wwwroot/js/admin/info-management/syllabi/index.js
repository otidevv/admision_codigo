(function () {
    const initialData = window.SyllabiData || [];

    $(document).ready(function () {
        DT.load('syllabiTable', { data: initialData });
        ...
        $('#filterName').on('input', function () {
            ...
            DT.load('syllabiTable', { data: filtered });
        });
    ...
    async function deleteFile(id, name) {
        ...
        if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = `/admin/info-management/syllabi/eliminar/${id}`;
