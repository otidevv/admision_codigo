(function () {
    const initialData = window.RegulationsData || [];

    $(document).ready(function () {
        DT.load('regulationsTable', { data: initialData });
        ...
        $('#filterName').on('input', function () {
            ...
            DT.load('regulationsTable', { data: filtered });
        });
    ...
    async function deleteFile(id, name) {
        ...
        if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = `/admin/info-management/regulations/eliminar/${id}`;
