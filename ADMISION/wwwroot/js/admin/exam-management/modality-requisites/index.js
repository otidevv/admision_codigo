(function () {
    $(document).ready(function () {
        const cfg = window.ModalityRequisitesIndexConfig || {};
        ...
        function loadTypes(modalityId) {
            if (window.customSelectRegistry['TypeModalityId']) {
                ...
                typeSelect.clear();
                if (modalityId) typeSelect.load('/admin/exam-management/requirements-by-modality/api/types/' + modalityId);
            }
        }
        ...
        function applyFilters() {
            ...
            DT.filter('modalityRequisitesTable', params);
        }
        ...
        document.addEventListener('dt:action', function (e) {
            ...
            if (key === 'delete') {
                Swal.fire({
                    ...
                    text: 'Esta acción eliminará el requisito asignado a la modalidad de forma permanente.',
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.method = 'POST';
                        form.action = '/admin/exam-management/requirements-by-modality/eliminar/' + row.id;
